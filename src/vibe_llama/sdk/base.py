...
class VibeLlamaScaffold:
    ...
    async def get_template(
        ...
        Args:
            template_name (ProjectName): Name of the template. You can find all the available templates in the remote GitHub repositories (see README). Defaults to `basic` if not provided.
